...
@Provider
public class CCBServerErrorExceptionMapper implements ExceptionMapper<CCBServerErrorException>{

	@Override
	public Response toResponse(CCBServerErrorException exception) {
